...
def get_whole_u_v_os(df):
    ...
    m, n = df.shape
    # micro_data_src = 'datasets/CASME3/Part_A_ME_clip_scrfd_cropped/'
    micro_data_src = 'datasets/CASME3/Part_A_ME_clip/frame'
    # macro_data_src = 'datasets/CASME3/Part_A_MaE_clip_scrfd_cropped/'
    macro_data_src = 'datasets/CASME3/Part_A_MaE_clip/frame'

    base_whole_destination_folder = 'datasets/CASME3/casme3_original+mtcnn_tvl1_norm_u_v_os_all_324'
